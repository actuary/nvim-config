...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/undotree",
